...
{ 
    ...
    { 
        ...
        {
	    System.out.println("\n");
            System.out.println("--EXCEPTION: MY TRY CATCH CAUGHT A GENERIC EXCEPTION IN A METHOD" + "\n" + 
			       "IN A SET METHOD FOR BAD VALUE OF X1 FOR AN EXISTING LINE\n");
            System.out.println(e + "\n");
        }
        ...
        System.out.println("Y2 = 400");

        TwoDPoint point1 = new TwoDPoint(10, 100);
        TwoDPoint point2 = new TwoDPoint(5, 400);
        System.out.println("SUCCESS \n");
        ...
        {
            System.out.println("EXCEPTION: This try catch caught a Generic Exception for a bad constructor - Failed to create a "
			       + "\n" + "line with 4 invalid values-leaving with rc of 88\n\n\n");
