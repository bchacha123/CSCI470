...
public class DesignLayout extends JPanel implements ActionListener
{
	// Declaring the .gifs
	...
	final TileCanvas centerCanvas = new TileCanvas();
	...
	public DesignLayout()
	{
		...
		// Pointer to the top toolbar from main panel 
